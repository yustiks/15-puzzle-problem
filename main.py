...
class EightPuzzle:
    ...
    def solve(self, h):
        ...
        def is_solved(puzzle):
            if ((puzzle.adj_matrix[1][1]==_goal_state[1][1]) and
                    (puzzle.adj_matrix[2][1]==_goal_state[2][1]) and
                    (puzzle.adj_matrix[3][1]==_goal_state[3][1])):
                return True
            else:
                return False
